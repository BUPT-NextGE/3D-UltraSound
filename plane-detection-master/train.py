...
class Config(object):
    ...
    # File paths
    data_dir = '/mnt/DataDrive5/fengshaowei/ultra_sound/3D/plane-detection-master/data/Images'
    label_dir = '/mnt/DataDrive5/fengshaowei/ultra_sound/3D/plane-detection-master/data/Landmarks'
    train_list_file = '/mnt/DataDrive5/fengshaowei/ultra_sound/3D/plane-detection-master/data/list_train.txt'
    test_list_file = '/mnt/DataDrive5/fengshaowei/ultra_sound/3D/plane-detection-master/data/list_test.txt'
    log_dir = 'mnt/DataDrive5/fengshaowei/ultra_sound/3D/plane-detection-master/logs'
    model_dir = 'mnt/DataDrive5/fengshaowei/ultra_sound/3D/plane-detection-master/cnn_model'
    # General parameters
